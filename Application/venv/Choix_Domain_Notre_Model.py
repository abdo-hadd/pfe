...
def Choix_Domain_Notre_Model(path,Domain1,Domain2,Domain3):
    mypath = path
        ...
        if fileName.endswith(".pdf") or fileName.endswith(".docx") or fileName.endswith(".doc"):
            ...
            if data['skills'] != []:
                if data['domain1'] == Domain1 and data['domain2'] == Domain2 and data['domain3'] == Domain3:
                    ...
                    fun.SEXE_1.append(fun.gender(Prenom, Nom))
                    ...
                    fun.SEXE_2.append(fun.gender(Prenom, Nom))
                    ...
                    fun.SEXE_3.append(fun.gender(Prenom, Nom))
                    ...
                    fun.SEXE_4.append(fun.gender(Prenom, Nom))
    ...
    NombreCvD4 = fun.cnt_4_pdf + fun.cnt_4_docx + fun.cnt_4_doc
    NombreCvLue = NombreCvD1 + NombreCvD2 + NombreCvD3 + NombreCvD4
    ...
    df_Domain1.to_csv('./Choix_Domain_Notre_Model/Domain1.csv', index=False)
    df_Domain2.to_csv('./Choix_Domain_Notre_Model/Domain2.csv', index=False)
    df_Domain3.to_csv('./Choix_Domain_Notre_Model/Domain3.csv', index=False)
    df_Domain4.to_csv('./Choix_Domain_Notre_Model/Domain4.csv', index=False)
