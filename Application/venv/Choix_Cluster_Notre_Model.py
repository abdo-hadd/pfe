...
def Choix_Cluster_Notre_Model(path,K_cluster):
    mypath = path
    ...
    for fileName in onlyfiles:
        if fileName.endswith(".pdf") or fileName.endswith(".docx") or fileName.endswith(".doc"):
            ...
            if data['skills'] != []:
                    ...
                    fun.domain_Intres_pdf.append(Domain)
    ...
    df_Intres.to_csv('./Choix_Cluster_Notre_Model/Cluster.csv', index=False)
